...
BASE_RESULTS_ROOT = f"/scratch/{USERNAME}/Exp/results_TimesNet_dilate_wo_align_dis/"
CKPT_ROOT = f"/scratch/{USERNAME}/models/MGD_CVAE_dilate_wo_align_dis/checkpoints/"
