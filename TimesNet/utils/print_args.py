def print_args(args):
    print("\033[1m" + "Basic TSTConfig" + "\033[0m")
    print(f'  {"Problem Path:":<20}{args.problem_path:<20}')
    print(f'  {"Results Path:":<20}{args.results_path:<20}')
    print(f'  {"Dataset:":<20}{args.dataset:<20}')
    print(f'  {"Classifier:":<20}{args.classifier_name:<20}')
    print(f'  {"Resample ID:":<20}{args.resample_id:<20}')
    print(
