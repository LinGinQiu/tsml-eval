...
from tsml_eval._wip.rt.transformations.collection.imbalance.TimeVAE.vae.vae_base import BaseVariationalAutoencoder, Sampling
...
class TimeVAE(BaseVariationalAutoencoder):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.compile(optimizer=Adam(), run_eagerly=True) # 添加 run_eagerly=True
